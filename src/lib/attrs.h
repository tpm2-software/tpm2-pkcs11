...
#define CKA_TPM2_SERIALIZED_TR   (CKA_VENDOR_DEFINED|CKA_VENDOR_TPM2_DEFINED|0x5UL)
#define CKA_TPM2_POLICY_JSON     (CKA_VENDOR_DEFINED|CKA_VENDOR_TPM2_DEFINED|0x6UL)
