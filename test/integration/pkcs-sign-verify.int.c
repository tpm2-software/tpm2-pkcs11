...
static void test_sign_verify_CKM_ECDSA(void **state) {
    ...
    assert_true(siglen >= 1);
    assert_true(siglen <= tmp_len);
...
static void test_sign_verify_CKM_ECDSA_SHA1(void **state) {
    ...
    assert_true(ckm_ecdsa_sha1_siglen >= 1);
    assert_true(ckm_ecdsa_sha1_siglen <= tmp_len);
...
static void test_sign_verify_CKM_ECDSA_SHA256(void **state) {
    ...
    assert_int_equal(rv, CKR_OK);
    /* actual size must not be larger than previously indicated */
    assert_true(ckm_ecdsa_sha256_siglen >= 1);
    assert_true(ckm_ecdsa_sha256_siglen <= tmp_len);
...
static void test_sign_verify_CKM_ECDSA_SHA384(void **state) {
    ...
    assert_int_equal(rv, CKR_OK);
    /* actual size must not be larger than previously indicated */
    assert_true(ckm_ecdsa_sha384_siglen >= 1);
    assert_true(ckm_ecdsa_sha384_siglen <= tmp_len);
...
static void test_sign_verify_CKM_ECDSA_SHA512(void **state) {
    ...
    assert_int_equal(rv, CKR_OK);
    /* actual size must not be larger than previously indicated */
    assert_true(ckm_ecdsa_sha512_siglen >= 1);
    assert_true(ckm_ecdsa_sha512_siglen <= tmp_len);
